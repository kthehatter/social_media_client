  ...
  return (
    <div className="relative bg-dark_one">
      ...
      <div className="md:hidden absolute w-full  bottom-0 z-50 bg-dark_one backdrop-brightness-50 ">
        <BottomNavigationBar setShowMoreModal={setShowMoreModal} />
      </div>
      {showMoreModal && (
              ...
              <nav className="w-72 text-white space-y-3 px-2 pt-20">
                ...
                <Link href="/stories">
                  <a
                    className={
                      page === "stories"
                        ? "mt-1 group flex items-center px-2 py-2 text-xl  leading-6  rounded-full bg-gray-800 text-blue-300"
                        : "mt-1 group flex items-center px-2 py-2 text-xl  leading-6  rounded-full hover:bg-gray-800 hover:text-blue-300"
                    }
                  >
                    <svg
                      className="h-8 w-8"
