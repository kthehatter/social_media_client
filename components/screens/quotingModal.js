...
import { quotePostApiCall } from "../../controllers/screens/posts/quotePost";
import { addPost } from "../../features/posts/posts";

export default function QuotingModal(props) {
  ...
  const postImageContent = props.postDetails.images
  ...
  const uploadPost = async () => {
    setIsUploading(true);
    await quotePostApiCall(props.postDetails.post_id,postContent, postVideo, postImage)
      .then((res) => {
        if (res.status === 200) {
          setPostContent("");
          setPostImage("");
          ...
          <div className="flex items-center">
            <div className="flex-1 text-center px-1 py-1 m-2">
              <button
                ...
                className="mt-1 group flex items-center text-blue-400 px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-gray-700 hover:text-blue-300"
              >
                <svg
            ...
            <div className="flex-1 text-center py-2 m-2">
              <button className="mt-1 group flex items-center text-blue-400 px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-gray-700 hover:text-blue-300">
                <svg
                  className="text-center h-7 w-6"
                  fill="none"
                  strokeLinecap="round"
