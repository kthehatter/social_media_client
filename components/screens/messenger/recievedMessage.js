...
export default function RecievedMessage(props) {
  ...
  return (
    <Fragment>
      <div
        className={
          nextMessageIsRecieved === true
            ? `flex py-1 ml-8 flex-row justify-start`
            : `flex flex-row py-1 justify-start`
        }
      >
        <div className="flex flex-row justify-start">
          {!nextMessageIsRecieved && (
            <div className="w-6 h-6 relative flex flex-shrink-0 mr-2">
              <img
